...
namespace RGZ.Views.DefaultTableCreateRow
{
    public partial class TeamView : Window
    {
        ...
        public TeamView(SecondWindowViewModel? mainContext) : this()
        {
            this.DataContext = new TeamViewModel(mainContext);
        }
        ...
        {
            var dc = (this.DataContext as TeamViewModel);
            dc.MainContext.Data.Teams.Add(dc.Teams);
